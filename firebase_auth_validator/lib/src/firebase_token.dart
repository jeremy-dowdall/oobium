...
class FirebaseToken {
  ...
  static FirebaseToken decode({required String token, required String projectId, required Map<String, String> publicKeys}) {
    final jwt = JWT.parse(token);
    final errors = <String>[];
    final validated = (projectId != null || publicKeys != null);
