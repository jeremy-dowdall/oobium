...
import 'package:oobium_connect/src/services/admin_service.dart';
import 'package:oobium_connect/src/services/auth_service.dart';
import 'package:oobium_connect/src/services/data_service.dart';
import 'package:oobium_connect/src/services/user_service.dart';
...
Future<List<String>> onMessage(String path, String event) async {
  ...
  switch(sa[1]) {
    case '/ds/destroy':
      ...
      return [event, '200'];
    case '/ds/get':
      return [event, jsonEncode(ds.get(sa[2]))];
    case '/ds/getAll':
      return [event, jsonEncode(ds.getAll())];
    case '/ds/count':
